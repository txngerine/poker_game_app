...
import '../view/dob_page.dart';

class KycImagePreviewPageDark extends StatefulWidget {
  final String imagePath;

  const KycImagePreviewPageDark({super.key, required this.imagePath});

  @override
  State<KycImagePreviewPageDark> createState() => _KycImagePreviewPageDarkState();
}

class _KycImagePreviewPageDarkState extends State<KycImagePreviewPageDark> {
