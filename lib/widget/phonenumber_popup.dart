...
//     showCountryPickerPopup(context); // shows country picker popup
//   });
// },
...
//   const CountryPickerPopupContent({required this.width, required this.height});
...
//                                 Future.delayed(const Duration(milliseconds: 300), () {
//                                   showPhoneNumberPopup(context, phoneNumber: '');
//                                 });
//                               },
//                             );
//                           },
...
void showPhoneNumberPopup(BuildContext context, {required String phoneNumber,required Function(String) onPhoneNumberUpdated,}) {
  showDialog(
    context: context,
    barrierDismissible: true,
    builder: (context) {
...
//   PhoneNumberPopupContent({super.key});
...
//               GestureDetector(
//                 onTap: () {
//                   countryProvider.updatePhoneNumber(phoneController.text);
//                   countryProvider.sentPhoneNumber(context);
//                 },
//                 child: Image.asset(
//                   width: width / 1.5,
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return ListTile(
                              ...
                              onTap: () {
                                ...
                                Navigator.pop(context);
                                Future.delayed(const Duration(milliseconds: 300), () {
                                  showPhoneNumberPopup(context, phoneNumber: '', onPhoneNumberUpdated: (String ) {  });
                                });
                              },
                            );
                          },
